...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('estatemaster', '0010_alter_professionalprofile_mortgage_types_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('obj2', models.CharField(choices=[('flat', 'Квартира'), ('room', 'Комната'), ('house', 'Дом'), ('place', 'Койко-место')], max_length=100)),
                ...
                ('obj3', models.CharField(choices=[('office', 'Офис'), ('building', 'Здание'), ('retail_space', 'Торговая площадь'), ('free_place', 'Помещение свободного назначения'), ('production', 'Производство'), ('warehouse', 'Склад'), ('garage', 'Гараж'), ('business', 'Бизнес'), ('commercial_land', 'Коммерческая земля')], max_length=100)),
                ...
                ('prepayment2', models.CharField(choices=[('4', '4 мес'), ('5', '5 мес'), ('6', '6 мес'), ('7', '7 мес'), ('8', '8 мес'), ('9', '9 мес'), ('10', '10 мес'), ('11', '11 мес'), ('year', 'Год')], max_length=30)),
